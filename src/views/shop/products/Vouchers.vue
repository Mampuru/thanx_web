  ...
  <div>
    ...
    <main class="" style="margin-top: 5rem; margin-bottom:5rem; padding:">
      <div class="container mx-auto px-4">">
        ...
        <div class="w-full md:w-5/12 px-4 flex-1" style="padding: 4rem;">
          ...
          <div>
              <p class="text-lg font-light mt-4 mb-4 text-blueGray-600">
        ...
        <div>
            <h4>Please enter the amount of vouchers you would like to purchase</h4>
            <br/>
            <div class="mb-3 pt-0">
            ...
            <div class="flex flex-wrap">  
                <div class="w-full px-4 flex-1">
                    <form action="${process.env.PAY_FAST_URL}" method="post">
                        ...
                        <input type="hidden" name="item_name" value="Voucher">
