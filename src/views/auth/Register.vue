              ...
              <small>Or sign up with credentials</small>
						...
						<form>
							...
							<div class="container px-4 mx-auto">
								<div class="flex flex-wrap">
									<div class="w-full px-4 flex-1">
										<span
											class="text-sm block my-4 p-3 text-blueGray-700"
										>
											<input
												type="radio"
												id="phone"
							...
							<div class="relative w-full mb-3">
								...
								/>
								<span
									class="z-10 h-full leading-snug font-normal absolute text-center text-blueGray-700 absolute bg-transparent rounded text-base items-center justify-center w-8 right-0 pr-3 py-3"
								>
									<i
										class="fas fa-eye"
							...
							<div class="relative w-full mb-3">
								...
								<span
									class="text-red-500"
									v-if="input.password !== confirm_password"
...
export default {
	setup() {
		...
		async function register() {
			...
			if (error.value === "") {
				store.commit("setShowLoader", false);
				router.push(`/${input.value.username}`);
			}
		}
